...
<div class="content-card" style="border: 1px solid #D1D5DB; border-radius: 15px; padding: 40px; background: white; height: auto; overflow: visible;">
    <form action="{{ route('murid.update', $murid->id) }}" method="POST">
        ...
        <div style="margin-bottom: 20px;">
            ...
            <input type="text" name="nama_lengkap" value="{{ old('nama_lengkap', $murid->nama_lengkap) }}" class="form-input" style="width: 100%; padding: 12px 15px; border-radius: 10px; border: 1px solid #E5E7EB; background: #F9FAFB;" required>
        </div>
        ...
        <div style="margin-bottom: 25px;">
            ...
            <input type="text" name="alamat" value="{{ old('alamat', $murid->alamat) }}" class="form-input" style="width: 100%; padding: 12px 15px; border-radius: 10px; border: 1px solid #E5E7EB; background: #F9FAFB;">
        </div>

        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 30px; margin-bottom: 20px;">
            <div>
                <label style="font-weight: 500; display: block; margin-bottom: 8px;">No HP Siswa</label>
                <input type="text" name="no_hp_siswa" value="{{ old('no_hp_siswa', $murid->no_hp_siswa) }}" class="form-input" style="width: 100%; padding: 12px 15px; border-radius: 10px; border: 1px solid #E5E7EB; background: #F9FAFB;">
            </div>
            <div>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 30px; margin-bottom: 40px;">
            <div>
                ...
                <input type="text" name="no_hp_ortu" value="{{ old('no_hp_ortu', $murid->no_hp_ortu) }}" class="form-input" style="width: 100%; padding: 12px 15px; border-radius: 10px; border: 1px solid #E5E7EB; background: #F9FAFB;">
            </div>
            <div>
        ...
        <div style="display: flex; justify-content: flex-end; gap: 15px; padding-bottom: 20px;">
